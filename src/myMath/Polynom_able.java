...
public interface Polynom_able extends cont_function{
	 ...
	 * @param p1 its Polynom that I add to my Polynom
	 */
	 ...
	 * @param p1 its Polynom that I substract to my Polynom
	 */
	public void substract(Polynom_able p1);
	/**
	 * Multiply this Polynom by p1
	 * @param p1  its Polynom that I multiply to my Polynom
	 */
	public void multiply(Polynom_able p1);
	/**
	 * Test if this Polynom is logically equals to p1.
	 * @param p1 its Polynom that I check if its equals to my Polynom
	 * @return true iff this pulynom represents the same function ans p1
	 */
	public boolean equals (Polynom_able p1);
	/**
	 * Test if this is the Zero Polynom
	 * @return the answer if its zero (true/false)
	 */
	 ...
	 * @return my root between x0 to x1
	 */
	public double root(double x0, double x1, double eps);
	/**
	 * create a deep copy of this Polynum
	 *  @return Polynom that same to my Polynom
	 */
	public Polynom_able copy();
	/**
	 * Compute a new Polynom which is the derivative of this Polynom
	 * @return new Polynom after derivative
	 */
